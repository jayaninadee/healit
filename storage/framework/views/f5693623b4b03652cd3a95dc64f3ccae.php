                                    ...
                                    <form role="form" method="POST" action="sign-up">
                                        ...
                                        <div class="mb-3">
                                            <input type="text" id="name" name="name" class="form-control"
                                                placeholder="Enter your name" value="<?php echo e(old("name")); ?>" aria-label="Name"
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3">
                                            <input type="email" id="email" name="email" class="form-control"
                                                placeholder="Enter your email address" value="<?php echo e(old("email")); ?>" aria-label="Email"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                    <p class="mb-4 text-xs mx-auto">
                                        ...
                                        <a href="<?php echo e(route('sign-in')); ?>" class="text-dark font-weight-bold">Sign
                                            in</a>
                                    </p>
                                </div>
                            </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\HealIt\resources\views/auth/signup.blade.php ENDPATH**/ ?>